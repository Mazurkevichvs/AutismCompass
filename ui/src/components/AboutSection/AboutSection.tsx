  ...
  return (
    <Container maxWidth="lg" sx={{ height: '100vh' }}>
      <Box
        ...
        <Typography mb={'20px'} variant="body1" align="left" gutterBottom>
        ...
        <Typography mb={'30px'} variant="body1" align="left" gutterBottom>
          ...
          viverra nec erat sit ridiculus nunc. Suspendisse proin justo amet amet placerat et. Neque
          volutpat magna facilisis viverra.
        </Typography>
      </Box>
      <Box sx={{
          display: 'flex',
